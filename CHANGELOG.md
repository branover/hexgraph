...
## [0.10.0](https://github.com/branover/hexgraph/compare/hexgraph-v0.9.0...hexgraph-v0.10.0) (2026-08-15)
...
* add unrestricted HexGraph VR skill ([#308](https://github.com/branover/hexgraph/issues/308)) ([1ac157f](https://github.com/branover/hexgraph/commit/1ac157fb573c11abe90dda5e124804e2442506e9))
...
* integrate Codex project workflows ([#307](https://github.com/branover/hexgraph/issues/307)) ([b1370c5](https://github.com/branover/hexgraph/commit/b1370c5962e0fa981430fbde0604e934d39222bc))
...
* clean up abandoned re_script probes ([#309](https://github.com/branover/hexgraph/issues/309)) ([c1b4ce7](https://github.com/branover/hexgraph/commit/c1b4ce76173a812c3c939592457f38c623af8f3c))
...
* copy/hash firmware artifacts off the SQLite write lock (ingest/unpack/delete) ([#295](https://github.com/branover/hexgraph/issues/295)) ([960f54a](https://github.com/branover/hexgraph/commit/960f54aead6927fa4073880a4b9d0e9699bb146e))
...
* eliminate the O(N²) / long lock holds in link_same_code, reachability, and merge ([#297](https://github.com/branover/hexgraph/issues/297)) ([3b3613f](https://github.com/branover/hexgraph/commit/3b3613f1f038784b6f46ef9dc3c01267e3830e2d))
* give every seam-routed Ghidra op the dead-bridge degradation ([#301](https://github.com/branover/hexgraph/issues/301)) ([0ee9ae6](https://github.com/branover/hexgraph/commit/0ee9ae6ad9ba6e0594bf5adb2d052d67a155e382))
...
* index nodes once in extract-at-write enrichment (O(N²) write-lock stall) ([#291](https://github.com/branover/hexgraph/issues/291)) ([6eeb9ad](https://github.com/branover/hexgraph/commit/6eeb9ad570d7a1b15042ae748fa745c49d23f263))
...
* make re_search_code's decompile-on-demand grep reuse, bound, and price itself ([#298](https://github.com/branover/hexgraph/issues/298)) ([a74831c](https://github.com/branover/hexgraph/commit/a74831c8d0de8abf12834529e59997d8e9c88a6f))
...
* normalize new Ghidra PIE imports ([#310](https://github.com/branover/hexgraph/issues/310)) ([2970458](https://github.com/branover/hexgraph/commit/2970458c46c73990ae52d309695428b9edfc6eba))
* read re_hexdump bytes in the sandbox (r2 p8), not host pyelftools ([#290](https://github.com/branover/hexgraph/issues/290)) ([c51e952](https://github.com/branover/hexgraph/commit/c51e9523e9e4a965fff72587fbd5d2f3f9199ea5))
* rebuild the code-&gt;data xref index the large-binary fast profile drops ([#306](https://github.com/branover/hexgraph/issues/306)) ([9316379](https://github.com/branover/hexgraph/commit/9316379965d7033259082e35e96a080f8b1a84d7))
* recover a doomed session on a failed observation write (stop the SQL leak) ([#292](https://github.com/branover/hexgraph/issues/292)) ([6e55232](https://github.com/branover/hexgraph/commit/6e5523200fe542dced1aa88c9a0a63abbbdb6e25))
* release the write lock across fuzz reaper snapshot/teardown + campaign launch ([#296](https://github.com/branover/hexgraph/issues/296)) ([28e1d71](https://github.com/branover/hexgraph/commit/28e1d71e6cbe65d767b28d22b4516c44fe03b277))
* release the write lock across the two remaining Ghidra slow ops ([#293](https://github.com/branover/hexgraph/issues/293)) ([343149b](https://github.com/branover/hexgraph/commit/343149bd2a961701699742ad477e49daa72c6b3b))
...
* route on positive evidence of death, not on an unanswered probe ([#304](https://github.com/branover/hexgraph/issues/304)) ([bf303bd](https://github.com/branover/hexgraph/commit/bf303bdfa3a95d9bea9e22f7aeac715832097ae0))
* route re_resolve's section/symbol reads through the sandbox (drop host pyelftools) ([#294](https://github.com/branover/hexgraph/issues/294)) ([1acee19](https://github.com/branover/hexgraph/commit/1acee19113b75b4cbaca4a28af7802bb3c6eee00))
* route taint through the Ghidra seam, and correct stale/missing tool caveats ([#299](https://github.com/branover/hexgraph/issues/299)) ([e4444b9](https://github.com/branover/hexgraph/commit/e4444b9295e59f343e4dd046a2ffeafa7587f776))
