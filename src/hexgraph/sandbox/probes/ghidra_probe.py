...
_RE_ANALYZE_LEAD = (
    ...
    "then re-run this tool — it reuses that warm project, seconds per call rather than a "
    "whole-binary pass. This tool is warm-only and never runs a cold analysis "
