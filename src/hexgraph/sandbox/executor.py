...
class Executor(Protocol):
    def run_probe(self, probe, artifact, *, outdir=None, extra_args=None, requires_execution=False, extra_ro_mounts=None, allow_network=False, net_container=None, secret=None, resources=None, network_gate="network", image=None, project_mount=None, extra_env=None) -> RunResult: ...
    def run_json_probe(self, probe, artifact, *, outdir=None, extra_args=None, requires_execution=False, extra_ro_mounts=None, allow_network=False, resources=None, project_mount=None, extra_env=None) -> dict: ...
    # Dynamic-surface verb: run a probe that talks to a live Channel (no artifact file
    # mounted) — bounded egress when the policy permits. (docs/design/design-dynamic-surfaces.md)
    ...
    def start_detached(self, probe, artifact, *, name, outdir, image=None, extra_args=None, requires_execution=False, extra_ro_mounts=None, resources=None, allow_network=False, net_container=None, disable_aslr=False, extra_env=None, project_mount=None) -> DetachedHandle: ...
