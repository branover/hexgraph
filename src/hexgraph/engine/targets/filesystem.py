...
def list_filesystem(project: Project, firmware: Target, session=None, *,
    ...
    Filter/paginate for big firmware (an IOS-XE image unpacks to hundreds-to-thousands of
...
def packed_containers(files: list[dict]) -> list[dict]:
    ...
    the "promote this to go deeper" set (F07). A Cisco IOS-XE image leaves its iosd/WebUI/SSH
