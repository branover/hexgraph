...
_GHIDRA_XREF_LEAD = (
    ...
    "then re-run this — it answers from the warm reference index, seconds per call rather "
    "than a whole-binary pass. If a Ghidra bridge is running but unhealthy, re_bridge_stop "
