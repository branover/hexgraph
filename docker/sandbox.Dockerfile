...
# Ghidra 11.1.2 is the last line that runs on JDK 17 (this image's openjdk-17);
# 11.2+ needs JDK 21. Bump both together with the JDK if you move up.
...
# Ghidra is opt-in (large; pulls a headless JDK + the Ghidra distribution). The
